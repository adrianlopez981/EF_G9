    ...
    <div class="modal-body" >
      <form method="post" action="<%=request.getContextPath()%>/?action=login">
        ...
        <div class="form-floating mb-1">
          ...
          <label for="floatingInput1">Grosor de línea</label>
        </div>
        <div class="form-floating mb-1">
          <input name="pass" type="password" class="form-control" id="floatingInput2" placeholder="Password">
          <label for="floatingInput2">Color de línea</label>
        </div>
        <div class="form-floating mb-1">
          <input name="pass" type="password" class="form-control" id="floatingInput2" placeholder="Password">
        ...
        <div class="form-floating mb-1">
          <input name="pass" type="password" class="form-control" id="floatingInput2" placeholder="Password">
          <label for="floatingInput2">Dimesiones</label>
        </div>
        <div class="form-floating mb-1">
          <input name="pass" type="password" class="form-control" id="floatingInput2" placeholder="Password">
        ...
        <div class="form-floating mb-1" >
          <button type="submit" class="btn btn-danger rounded-pill botonInicio border border-primary" style="transform: translateX(230%); background-color: black; color: #0d6efd">Registro</button>
        </div>
    </div>
